									...
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
												...
												<h4 class="blue bigger">Form Untuk edit data penyidik</h4>
											</div>
											...
											<div class="modal-body">
												<div class="row">
													...
													<input type="hidden" id="id" name="id" value="<?php echo $data['kdpenyidik'] ?>" class="form-control"/>
														...
														<div class="space-4"></div>
														<div class="form-group">
															<label for="form-field-select-3">nohp</label>
														...
														<div class="form-group">
															...
															<div>
																<input type="text" id="pangkat" name="pangkat" value="<?php echo $data['pangkat'] ?>" class="form-control"/>
															</div>
														</div>
