					...
					<div class="table-responsive">
						<table class="table table-striped table-bordered table-hover">
							...
							<?php 
								...
								$no=1;
								$tampil=mysqli_query($koneksi,"SELECT * FROM masyarakat") or die(mysqli_error());
							...
							<tbody>
								...
								<td>
									<a href="./controller/pelapor/edit?id=<?php echo $r['nik'] ?>"  data-toggle="modal" >Edit</a> |||
									<a href="./controller/pelapor/hapus.php?id=<?php echo $r['nik'] ?>">Hapus</a>
								</td>
							</tbody>
							<?php 
								endwhile;
								...
								<div class="row">
									...
									<div class="col-xs-12 col-sm-7">
										<div class="form-group">
											...
											<div>
												<input type="text" id="noktp" name="noktp" placeholder="Nomor KTP" class="form-control" required maxlength="15"/>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div>
												<input type="password" id="password" name="password" placeholder="Masukkan Password" class="form-password" style="width:321.33px;"/>
