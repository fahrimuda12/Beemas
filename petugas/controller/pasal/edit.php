										...
										<div class="modal-content">
											...
											<div class="modal-body">
												<div class="row">
													...
													<input type="hidden" id="id" name="id" value="<?php echo $data['nopasal'] ?>" class="form-control"/>
														<div class="form-group">
															<label for="form-field-select-3">Keterangan pasal</label>

															<div>
																<input type="text" id="ket_pasal" name="ket_pasal" value="<?php echo $data['ket_pasal'] ?>" class="form-control"/>
															</div>
														</div>
