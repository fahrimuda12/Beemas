				...
				<!-- PAGE CONTENT BEGINS -->
					<div class="alert alert-block alert-success">
						...
						<div class="table-responsive">
							<table id="dynamic-table" class="table table-striped table-bordered table-hover tableku">
								<thead>
									<th>No</th>
									<th>Id Tanggapan</th>
									<th>Id Pengaduan</th>
								...
								<?php 
									...
									$no=1;
									$tampil=mysqli_query($koneksi,"SELECT * FROM tanggapan INNER JOIN pengaduan ON tanggapan.id_pengaduan = pengaduan.id_pengaduan ORDER BY tgl_tanggapan ASC  ") or die(mysqli_error());
									while($r=mysqli_fetch_array($tampil)):
								?>
								<tbody>
									<td><?php echo $no++ ;?></td>
									<td><?php echo $r['id_tanggapan']?></td>
									...
									<td>
										<a href="./controller/tanggapan/edit?id=<?php echo $r['id_tanggapan'] ?>"  data-toggle="modal" >Edit</a> |||
										<a href="./controller/tanggapan/hapus.php?id=<?php echo $r['id_tanggapan'] ?>"  data-toggle="modal" >Hapus</a>
									</td>
								</tbody>
								<?php 
									endwhile;
