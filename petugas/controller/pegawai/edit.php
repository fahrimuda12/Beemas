									...
									<div class="modal-dialog">
										<div class="modal-content">
												...
												<div class="row">
													<div class="col-xs-12 col-sm-12">
														...
														<div class="form-group">
															<label for="form-field-select-3">Id Petugas</label>
															<div>
																<input type="text" id="id" name="id" readonly placeholder="id" class="form-control"  value="<?php echo $data['id_petugas'] ?>" />
															</div>
														</div>
														<div class="space-4"></div>
														<div class="form-group">
															...
															<div>
																<input type="text" id="nama" name="nama" placeholder="Silahkan Input Nama" class="form-control"  required value="<?php echo $data['nama_petugas'] ?>" />
															</div>
														</div>
														<div class="space-4"></div>
														<div class="form-group">
														...
														<div class="form-group">
															...
															<div>
																<input type="password" id="password" name="password" placeholder="Silahkan Input Password" required class="form-control"  value="<?php echo $data['username'] ?>" />
															</div>
														</div>
														<div class="space-4"></div>
														<div class="form-group">
											...
											<div class="modal-footer">
												<a href="../../?view=pegawai" class="btn btn-sm" data-dismiss="modal">
