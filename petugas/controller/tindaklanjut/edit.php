...
<input type="hidden" name="id" name="id" value="<?php echo  $data['notlhp'] ?>">
...
<div class="space-4"></div>
														<div class="form-group">
															...
															<div>
																<input type="text" id="tgl_tlhp" name="tgl_tlhp" value="<?php echo $data['tgl_tlhp'] ?>" class="form-control"/>
															</div>
														</div>
<div class="space-4"></div>
														<div class="form-group">
														...
														<div class="form-group">
															...
															<div>
																<input type="text" id="jumlah_tim" name="jumlah_tim" value="<?php echo $data['jumlah_tim'] ?>" class="form-control"/>
															</div>
														</div>
														<div class="space-4"></div>
														<div class="form-group">
															...
															<div>
																<input type="text" id="catatan_pemeriksaan" name="catatan_pemeriksaan" value="<?php echo $data['catatan_pemeriksaan'] ?>" class="form-control"/>
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div>
																<input type="text" id="hasil_sitaan" name="hasil_sitaan" value="<?php echo $data['hasil_sitaan'] ?>" class="form-control"/>
															</div>
														</div>
